      ...
      <div class="app-content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                    ...
                    <div class="p-0 card-body">
                      <div class="m-1 text-center row">
                        <div class="p-2 col-3">
                          ...
                          />
                          <a
                            class="p-0 btn fw-bold fs-7 text-secondary text-truncate w-100"
                            href="#"
                          >
                            Alexander Pierce
                          </a>
            ...
            <div class="col-md-4">
              <!-- Info Boxes Style 2 -->
              <div class="mb-3 info-box text-bg-warning">
              ...
              <!-- /.info-box -->
              <div class="mb-3 info-box text-bg-success">
              ...
              <!-- /.info-box -->
              <div class="mb-3 info-box text-bg-danger">
              ...
              <!-- /.info-box -->
              <div class="mb-3 info-box text-bg-info">
              ...
              <div class="card">
                ...
                <div class="p-0 card-body">
                  <div class="px-2">
                    <div class="px-1 py-2 d-flex border-top">
                      <div class="col-2">
                        <img
